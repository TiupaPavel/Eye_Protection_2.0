...
namespace Task_9
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            version19ToolStripMenuItem = new ToolStripMenuItem();
            ...
            menuStrip1.Items.AddRange(new ToolStripItem[] { fileToolStripMenuItem, editToolStripMenuItem, aboutToolStripMenuItem, version19ToolStripMenuItem });
            ...
            // 
            aboutToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { programToolStripMenuItem, developerToolStripMenuItem, donateToolStripMenuItem });
            ...
            programToolStripMenuItem.Size = new Size(161, 26);
            ...
            developerToolStripMenuItem.Size = new Size(161, 26);
            developerToolStripMenuItem.Text = "Developer";
            developerToolStripMenuItem.Click += button5_Click;
            // 
            // donateToolStripMenuItem
            // 
            donateToolStripMenuItem.BackColor = Color.Gray;
            donateToolStripMenuItem.Name = "donateToolStripMenuItem";
            donateToolStripMenuItem.Size = new Size(161, 26);
            donateToolStripMenuItem.Text = "Donate";
            // 
            // version19ToolStripMenuItem
            // 
            version19ToolStripMenuItem.BackColor = Color.Gray;
            version19ToolStripMenuItem.Name = "version19ToolStripMenuItem";
            version19ToolStripMenuItem.Size = new Size(94, 24);
            version19ToolStripMenuItem.Text = "Version 1.9";
            // 
            // Form1
            // 
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                try
                {
                    if (File.Exists(selectedFilePath))
                    {
                        ...
                        MessageBox.Show("Профіль успішно видалено.", "Видалення профілю", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        label6.Text = "...";
                    }
                    else
                    {
                        MessageBox.Show("Файл не знайдений.", "Помилка", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                }
                catch (Exception ex)
                {
                    MessageBox.Show($"Сталася помилка при видаленні файлу: {ex.Message}", "Помилка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private ToolStripMenuItem version19ToolStripMenuItem;
